...
To build the final jar and optimize the ecfgatewaysvc application for production, run:
...
Then navigate to [http://localhost:7010](http://localhost:7010) in your browser.
