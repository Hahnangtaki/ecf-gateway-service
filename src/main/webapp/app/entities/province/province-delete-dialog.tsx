...
export interface IProvinceDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class ProvinceDeleteDialog extends React.Component<IProvinceDeleteDialogProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ecfgatewaysvcApp.province.delete.question">Are you sure you want to delete this Province?</ModalBody>
        <ModalFooter>
