...
public class CompanyBank implements Serializable {
    ...
    public CompanyBank createSystemDate(LocalDate createSystemDate) {
    ...
    public CompanyBank createDate(ZonedDateTime createDate) {
    ...
    public CompanyBank createUserId(Long createUserId) {
    ...
    public CompanyBank lastModificationSystemDate(LocalDate lastModificationSystemDate) {
    ...
    public CompanyBank lastModificationDate(ZonedDateTime lastModificationDate) {
    ...
    public CompanyBank lastModificationUserId(Long lastModificationUserId) {
