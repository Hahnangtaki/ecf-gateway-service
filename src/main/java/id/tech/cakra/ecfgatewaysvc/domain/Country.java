...
public class Country implements Serializable {
    ...
    public Country createSystemDate(LocalDate createSystemDate) {
    ...
    public Country createDate(ZonedDateTime createDate) {
    ...
    public Country createUserId(Long createUserId) {
    ...
    public Country lastModificationSystemDate(LocalDate lastModificationSystemDate) {
    ...
    public Country lastModificationDate(ZonedDateTime lastModificationDate) {
    ...
    public Country lastModificationUserId(Long lastModificationUserId) {
