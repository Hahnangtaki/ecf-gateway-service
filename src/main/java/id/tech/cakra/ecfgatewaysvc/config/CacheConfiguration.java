package id.tech.cakra.ecfgatewaysvc.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, id.tech.cakra.ecfgatewaysvc.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, id.tech.cakra.ecfgatewaysvc.repository.UserRepository.USERS_BY_EMAIL_CACHE);
