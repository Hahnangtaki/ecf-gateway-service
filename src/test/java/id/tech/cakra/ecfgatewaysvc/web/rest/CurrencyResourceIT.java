...
import id.tech.cakra.ecfgatewaysvc.repository.CurrencyRepository;
import id.tech.cakra.ecfgatewaysvc.service.CurrencyService;
import id.tech.cakra.ecfgatewaysvc.service.dto.CurrencyDTO;
import id.tech.cakra.ecfgatewaysvc.service.mapper.CurrencyMapper;
...
public class CurrencyResourceIT {
    ...
    private static final String DEFAULT_CURRENCY_SYMBOL = "AAAAA";
    private static final String UPDATED_CURRENCY_SYMBOL = "BBBBB";
    ...
    public void createCurrency() throws Exception {
        ...
        assertThat(testCurrency.getCreateSystemDate()).isEqualTo(DEFAULT_CREATE_SYSTEM_DATE);
        assertThat(testCurrency.getCreateDate()).isEqualTo(DEFAULT_CREATE_DATE);
        assertThat(testCurrency.getCreateUserId()).isEqualTo(DEFAULT_CREATE_USER_ID);
        assertThat(testCurrency.getLastModificationSystemDate()).isEqualTo(DEFAULT_LAST_MODIFICATION_SYSTEM_DATE);
        assertThat(testCurrency.getLastModificationDate()).isEqualTo(DEFAULT_LAST_MODIFICATION_DATE);
        assertThat(testCurrency.getLastModificationUserId()).isEqualTo(DEFAULT_LAST_MODIFICATION_USER_ID);
    }
    ...
    public void updateCurrency() throws Exception {
        ...
        assertThat(testCurrency.getCreateSystemDate()).isEqualTo(UPDATED_CREATE_SYSTEM_DATE);
        assertThat(testCurrency.getCreateDate()).isEqualTo(UPDATED_CREATE_DATE);
        assertThat(testCurrency.getCreateUserId()).isEqualTo(UPDATED_CREATE_USER_ID);
        assertThat(testCurrency.getLastModificationSystemDate()).isEqualTo(UPDATED_LAST_MODIFICATION_SYSTEM_DATE);
        assertThat(testCurrency.getLastModificationDate()).isEqualTo(UPDATED_LAST_MODIFICATION_DATE);
        assertThat(testCurrency.getLastModificationUserId()).isEqualTo(UPDATED_LAST_MODIFICATION_USER_ID);
    }
