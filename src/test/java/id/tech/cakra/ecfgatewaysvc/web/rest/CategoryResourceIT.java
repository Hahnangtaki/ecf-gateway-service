...
public class CategoryResourceIT {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCatCode()).isEqualTo(DEFAULT_CAT_CODE);
        assertThat(testCategory.getCatName()).isEqualTo(DEFAULT_CAT_NAME);
        assertThat(testCategory.getCreateSystemDate()).isEqualTo(DEFAULT_CREATE_SYSTEM_DATE);
        assertThat(testCategory.getCreateDate()).isEqualTo(DEFAULT_CREATE_DATE);
        assertThat(testCategory.getCreateUserId()).isEqualTo(DEFAULT_CREATE_USER_ID);
        assertThat(testCategory.getLastModificationSystemDate()).isEqualTo(DEFAULT_LAST_MODIFICATION_SYSTEM_DATE);
        assertThat(testCategory.getLastModificationDate()).isEqualTo(DEFAULT_LAST_MODIFICATION_DATE);
        assertThat(testCategory.getLastModificationUserId()).isEqualTo(DEFAULT_LAST_MODIFICATION_USER_ID);
    }
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getCatCode()).isEqualTo(UPDATED_CAT_CODE);
        assertThat(testCategory.getCatName()).isEqualTo(UPDATED_CAT_NAME);
        assertThat(testCategory.getCreateSystemDate()).isEqualTo(UPDATED_CREATE_SYSTEM_DATE);
        assertThat(testCategory.getCreateDate()).isEqualTo(UPDATED_CREATE_DATE);
        assertThat(testCategory.getCreateUserId()).isEqualTo(UPDATED_CREATE_USER_ID);
        assertThat(testCategory.getLastModificationSystemDate()).isEqualTo(UPDATED_LAST_MODIFICATION_SYSTEM_DATE);
        assertThat(testCategory.getLastModificationDate()).isEqualTo(UPDATED_LAST_MODIFICATION_DATE);
        assertThat(testCategory.getLastModificationUserId()).isEqualTo(UPDATED_LAST_MODIFICATION_USER_ID);
    }
